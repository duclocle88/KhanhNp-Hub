...
ImageButton1.Image = "https://www.roblox.com/vi/library/18977006616/NpKhanhHub"
...
local LogoHub = Instance.new("ImageLabel")
    ...
    LogoHub.Image = "https://www.roblox.com/vi/library/"..tostring(18977006616)
...
local LogoToggle = Instance.new("ImageLabel")
    ...
    LogoToggle.Image = "https://www.roblox.com/vi/library/"..tostring(18977006616)
...
local Library = Update:Window("           Domadic","18977006616",Enum.KeyCode.RightControl);
...
H:AddLabel("Wellcone To Script NpKhanhHub")
				...
				if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman",true) == 1 then
						...
						game.StarterGui:SetCore("SendNotification", {
							...
							Icon = "https://www.roblox.com/vi/library/18977006616/NpKhanhHub",
							Duration = 2.5
						})
					end
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep",true) == 1 then
...
function EquipWeaponSword()
    ...
    task.spawn(function()
            while task.wait() do
                pcall(function()
                    if game:GetService("Lighting").Sky.MoonTextureId=="https://www.roblox.com/vi/library/9709149431/moon5" then
                        FM:Set("🌕: Full Moon 100%")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="https://www.roblox.com/vi/library/9709149052/moon4" then
                        FM:Set("🌖’ : Full Moon 75%")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="https://www.roblox.com/vi/library/9709143733/moon3" then
                        FM:Set("🌗“ : Full Moon 50%")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="https://www.roblox.com/vi/library/9709150401/moon8" then
                        FM:Set("🌘 : Full Moon 25%")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="https://www.roblox.com/vi/library/9709149680/moon6" then
                        FM:Set("🌘: Full Moon 15%")
                    else
...
M:AddToggle("Auto Find Full Moon",_G.AutoFindFullmoon,function(value)
 ...
 spawn(function()
        while wait() do
            ...
            if game:GetService("Lighting").Sky.MoonTextureId=="https://www.roblox.com/vi/library/9709149052/moon4" or game:GetService("Lighting").Sky.MoonTextureId=="https://www.roblox.com/vi/library/9709149431/moon5" then
                wait(2.0)
                game.StarterGui:SetCore("SendNotification", {
					Title = "Domadic Hab", 
					Text = "Full Moon" ,
            ...
            elseif game:GetService("Lighting").Sky.MoonTextureId=="https://www.roblox.com/vi/library/9709143733" then
                Hop()
                game.StarterGui:SetCore("SendNotification", {
					Title = "NpKhanh Hub", 
            ...
            elseif game:GetService("Lighting").Sky.MoonTextureId=="https://www.roblox.com/vi/library/9709150401" then
                Hop()
                game.StarterGui:SetCore("SendNotification", {
					Title = "NpKhanh Hub", 
					Text = "Wait New Server" ,
            ...
            elseif game:GetService("Lighting").Sky.MoonTextureId=="https://www.roblox.com/vi/library/9709149680" then
                Hop()
                game.StarterGui:SetCore("SendNotification", {
					Title = "NpKhanh Hub", 
					Text = "Wait New Server" ,
...
print("NpKhanh Hub Load Complete")
